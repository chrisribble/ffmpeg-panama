...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, FFmpeg.C_POINTER).withName("__locales"),
        FFmpeg.C_POINTER.withName("__ctype_b"),
        FFmpeg.C_POINTER.withName("__ctype_tolower"),
        FFmpeg.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, FFmpeg.C_POINTER).withName("__names")
