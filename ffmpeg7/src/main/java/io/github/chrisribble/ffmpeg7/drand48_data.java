...
public class drand48_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, FFmpeg.C_SHORT).withName("__x"),
        MemoryLayout.sequenceLayout(3, FFmpeg.C_SHORT).withName("__old_x"),
        FFmpeg.C_SHORT.withName("__c"),
        FFmpeg.C_SHORT.withName("__init"),
        FFmpeg.C_LONG_LONG.withName("__a")
