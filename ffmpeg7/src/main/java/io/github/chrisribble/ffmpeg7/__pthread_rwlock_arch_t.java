...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        FFmpeg.C_INT.withName("__readers"),
        FFmpeg.C_INT.withName("__writers"),
        FFmpeg.C_INT.withName("__wrphase_futex"),
        FFmpeg.C_INT.withName("__writers_futex"),
        FFmpeg.C_INT.withName("__pad3"),
        FFmpeg.C_INT.withName("__pad4"),
        FFmpeg.C_INT.withName("__cur_writer"),
        FFmpeg.C_INT.withName("__shared"),
        FFmpeg.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, FFmpeg.C_CHAR).withName("__pad1"),
        FFmpeg.C_LONG.withName("__pad2"),
        FFmpeg.C_INT.withName("__flags"),
