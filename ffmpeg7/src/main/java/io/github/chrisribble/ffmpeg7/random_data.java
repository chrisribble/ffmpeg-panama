...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        FFmpeg.C_POINTER.withName("fptr"),
        FFmpeg.C_POINTER.withName("rptr"),
        FFmpeg.C_POINTER.withName("state"),
        FFmpeg.C_INT.withName("rand_type"),
        FFmpeg.C_INT.withName("rand_deg"),
        FFmpeg.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        FFmpeg.C_POINTER.withName("end_ptr")
