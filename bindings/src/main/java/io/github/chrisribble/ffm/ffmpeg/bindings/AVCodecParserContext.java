...
package io.github.chrisribble.ffm.ffmpeg.bindings;
...
public class AVCodecParserContext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        FFmpeg.C_LONG_LONG.withName("frame_offset"),
        FFmpeg.C_LONG_LONG.withName("cur_offset"),
        FFmpeg.C_LONG_LONG.withName("next_frame_offset"),
        ...
        FFmpeg.C_LONG_LONG.withName("last_pts"),
        FFmpeg.C_LONG_LONG.withName("last_dts"),
        FFmpeg.C_INT.withName("fetch_timestamp"),
        FFmpeg.C_INT.withName("cur_frame_start_index"),
        MemoryLayout.sequenceLayout(4, FFmpeg.C_LONG_LONG).withName("cur_frame_offset"),
        MemoryLayout.sequenceLayout(4, FFmpeg.C_LONG_LONG).withName("cur_frame_pts"),
        MemoryLayout.sequenceLayout(4, FFmpeg.C_LONG_LONG).withName("cur_frame_dts"),
        FFmpeg.C_INT.withName("flags"),
        MemoryLayout.paddingLayout(4),
        FFmpeg.C_LONG_LONG.withName("offset"),
        MemoryLayout.sequenceLayout(4, FFmpeg.C_LONG_LONG).withName("cur_frame_end"),
        ...
        MemoryLayout.sequenceLayout(4, FFmpeg.C_LONG_LONG).withName("cur_frame_pos"),
        FFmpeg.C_LONG_LONG.withName("pos"),
        FFmpeg.C_LONG_LONG.withName("last_pos"),
