...
public final class avcodec_default_execute2$func {
    ...
    private static final MethodHandle UP$MH = FFmpeg.upcallHandle(avcodec_default_execute2$func.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(avcodec_default_execute2$func.Function fi, Arena arena) {
