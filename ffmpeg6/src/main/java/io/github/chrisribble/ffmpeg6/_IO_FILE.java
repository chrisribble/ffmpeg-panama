...
public class _IO_FILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        FFmpeg.C_INT.withName("_flags"),
        MemoryLayout.paddingLayout(4),
        FFmpeg.C_POINTER.withName("_IO_read_ptr"),
        FFmpeg.C_POINTER.withName("_IO_read_end"),
        FFmpeg.C_POINTER.withName("_IO_read_base"),
        FFmpeg.C_POINTER.withName("_IO_write_base"),
        FFmpeg.C_POINTER.withName("_IO_write_ptr"),
        FFmpeg.C_POINTER.withName("_IO_write_end"),
        FFmpeg.C_POINTER.withName("_IO_buf_base"),
        FFmpeg.C_POINTER.withName("_IO_buf_end"),
        FFmpeg.C_POINTER.withName("_IO_save_base"),
        FFmpeg.C_POINTER.withName("_IO_backup_base"),
        FFmpeg.C_POINTER.withName("_IO_save_end"),
        ...
        MemoryLayout.sequenceLayout(1, FFmpeg.C_CHAR).withName("_shortbuf"),
        MemoryLayout.paddingLayout(4),
        FFmpeg.C_POINTER.withName("_lock"),
        FFmpeg.C_LONG.withName("_offset"),
        FFmpeg.C_POINTER.withName("_codecvt"),
