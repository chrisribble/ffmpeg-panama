...
public class FFmpeg_3 {
    ...
    private static final int LIBAVUTIL_VERSION_MAJOR = (int)58L;
    /**
     * {@snippet lang=c :
    ...
    private static final int LIBAVUTIL_VERSION_MINOR = (int)2L;
    /**
     * {@snippet lang=c :
    ...
    private static final int LIBAVCODEC_VERSION_MAJOR = (int)60L;
    /**
     * {@snippet lang=c :
    ...
    private static final int LIBAVFORMAT_VERSION_MAJOR = (int)60L;
    /**
     * {@snippet lang=c :
    ...
    private static final int LIBSWSCALE_VERSION_MAJOR = (int)7L;
    /**
     * {@snippet lang=c :
