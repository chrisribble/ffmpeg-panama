 ...
 * int (*callback)(void*);
    ...
    public interface callback {
        ...
        static MemorySegment allocate(callback fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$268.const$1, fi, constants$0.const$3, scope);
        }
    ...
    public static MemorySegment opaque$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$268.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment opaque$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$268.const$3.get(seg.asSlice(index*sizeof()));
    }
