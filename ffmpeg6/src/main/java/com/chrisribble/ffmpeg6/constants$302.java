...
final class constants$302 {
    ...
    static final VarHandle const$2 = constants$302.const$1.varHandle(MemoryLayout.PathElement.groupElement("av_class"));
    static final VarHandle const$3 = constants$302.const$1.varHandle(MemoryLayout.PathElement.groupElement("index"));
    static final VarHandle const$4 = constants$302.const$1.varHandle(MemoryLayout.PathElement.groupElement("id"));
    static final VarHandle const$5 = constants$302.const$1.varHandle(MemoryLayout.PathElement.groupElement("codecpar"));
}
