...
public class AVSubtitle {
    ...
    public static short format$get(MemorySegment seg) {
        return (short)constants$242.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short format$get(MemorySegment seg, long index) {
        return (short)constants$242.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long pts$get(MemorySegment seg) {
        return (long)constants$243.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long pts$get(MemorySegment seg, long index) {
        return (long)constants$243.const$0.get(seg.asSlice(index*sizeof()));
    }
