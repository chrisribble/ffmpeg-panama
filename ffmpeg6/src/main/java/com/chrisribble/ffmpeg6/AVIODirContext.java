...
public class AVIODirContext {
    ...
    public static MemorySegment url_context$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$270.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment url_context$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$270.const$4.get(seg.asSlice(index*sizeof()));
    }
