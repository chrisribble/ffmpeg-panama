...
public class AVPixFmtDescriptor {
    ...
    public static MemorySegment name$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$335.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment name$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$335.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte log2_chroma_w$get(MemorySegment seg) {
        return (byte)constants$335.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte log2_chroma_w$get(MemorySegment seg, long index) {
        return (byte)constants$335.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long flags$get(MemorySegment seg) {
        return (long)constants$335.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long flags$get(MemorySegment seg, long index) {
        return (long)constants$335.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment alias$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$336.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment alias$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$336.const$0.get(seg.asSlice(index*sizeof()));
    }
