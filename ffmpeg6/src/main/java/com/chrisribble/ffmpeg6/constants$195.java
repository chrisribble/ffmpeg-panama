...
final class constants$195 {
    ...
    static final VarHandle const$1 = constants$195.const$0.varHandle(MemoryLayout.PathElement.groupElement("codec_type"));
    static final VarHandle const$2 = constants$195.const$0.varHandle(MemoryLayout.PathElement.groupElement("codec_id"));
    static final VarHandle const$3 = constants$195.const$0.varHandle(MemoryLayout.PathElement.groupElement("codec_tag"));
    static final VarHandle const$4 = constants$195.const$0.varHandle(MemoryLayout.PathElement.groupElement("extradata"));
    static final VarHandle const$5 = constants$195.const$0.varHandle(MemoryLayout.PathElement.groupElement("extradata_size"));
}
