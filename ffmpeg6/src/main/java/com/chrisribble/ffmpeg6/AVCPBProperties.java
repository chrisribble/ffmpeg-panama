...
public class AVCPBProperties {
    ...
    public static long max_bitrate$get(MemorySegment seg) {
        return (long)constants$201.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long max_bitrate$get(MemorySegment seg, long index) {
        return (long)constants$201.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long min_bitrate$get(MemorySegment seg) {
        return (long)constants$201.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long min_bitrate$get(MemorySegment seg, long index) {
        return (long)constants$201.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long avg_bitrate$get(MemorySegment seg) {
        return (long)constants$201.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long avg_bitrate$get(MemorySegment seg, long index) {
        return (long)constants$201.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long buffer_size$get(MemorySegment seg) {
        return (long)constants$201.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long buffer_size$get(MemorySegment seg, long index) {
        return (long)constants$201.const$5.get(seg.asSlice(index*sizeof()));
    }
