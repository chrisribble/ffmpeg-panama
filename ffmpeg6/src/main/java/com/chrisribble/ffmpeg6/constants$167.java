...
final class constants$167 {
    ...
    static final VarHandle const$0 = constants$166.const$4.varHandle(MemoryLayout.PathElement.groupElement("top"));
    static final VarHandle const$1 = constants$166.const$4.varHandle(MemoryLayout.PathElement.groupElement("bottom"));
    static final VarHandle const$2 = constants$166.const$4.varHandle(MemoryLayout.PathElement.groupElement("left"));
    static final VarHandle const$3 = constants$166.const$4.varHandle(MemoryLayout.PathElement.groupElement("right"));
    ...
    static final VarHandle const$5 = constants$167.const$4.varHandle(MemoryLayout.PathElement.groupElement("extended_data"));
}
