...
final class constants$188 {
    ...
    static final VarHandle const$0 = constants$187.const$5.varHandle(MemoryLayout.PathElement.groupElement("profile"));
    static final VarHandle const$1 = constants$187.const$5.varHandle(MemoryLayout.PathElement.groupElement("name"));
    ...
    static final VarHandle const$3 = constants$188.const$2.varHandle(MemoryLayout.PathElement.groupElement("name"));
    static final VarHandle const$4 = constants$188.const$2.varHandle(MemoryLayout.PathElement.groupElement("long_name"));
    static final VarHandle const$5 = constants$188.const$2.varHandle(MemoryLayout.PathElement.groupElement("type"));
}
