...
public class tm {
    ...
    public static int tm_sec$get(MemorySegment seg) {
        return (int)constants$261.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int tm_sec$get(MemorySegment seg, long index) {
        return (int)constants$261.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int tm_min$get(MemorySegment seg) {
        return (int)constants$262.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int tm_min$get(MemorySegment seg, long index) {
        return (int)constants$262.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int tm_mon$get(MemorySegment seg) {
        return (int)constants$262.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void tm_mon$set(MemorySegment seg, int x) {
        constants$262.const$3.set(seg, x);
    }
    public static int tm_mon$get(MemorySegment seg, long index) {
        return (int)constants$262.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void tm_mon$set(MemorySegment seg, long index, int x) {
        constants$262.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int tm_year$get(MemorySegment seg) {
        return (int)constants$262.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int tm_year$get(MemorySegment seg, long index) {
        return (int)constants$262.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long tm_gmtoff$get(MemorySegment seg) {
        return (long)constants$263.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long tm_gmtoff$get(MemorySegment seg, long index) {
        return (long)constants$263.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment tm_zone$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$263.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment tm_zone$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$263.const$3.get(seg.asSlice(index*sizeof()));
    }
