...
public class tm {
    ...
    public static int tm_sec$get(MemorySegment seg) {
        return (int)constants$259.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int tm_sec$get(MemorySegment seg, long index) {
        return (int)constants$259.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int tm_min$get(MemorySegment seg) {
        return (int)constants$259.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int tm_min$get(MemorySegment seg, long index) {
        return (int)constants$259.const$1.get(seg.asSlice(index*sizeof()));
    }
