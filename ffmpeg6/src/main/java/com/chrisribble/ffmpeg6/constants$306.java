...
final class constants$306 {
    ...
    static final MethodHandle const$0 = RuntimeHelper.upcallHandle(AVOpenCallback.class, "apply", constants$305.const$5);
    ...
    static final VarHandle const$3 = constants$306.const$2.varHandle(MemoryLayout.PathElement.groupElement("av_class"));
    static final VarHandle const$4 = constants$306.const$2.varHandle(MemoryLayout.PathElement.groupElement("iformat"));
    static final VarHandle const$5 = constants$306.const$2.varHandle(MemoryLayout.PathElement.groupElement("oformat"));
}
