...
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.AVERROR_EOF;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.AVMEDIA_TYPE_VIDEO;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.SWS_BILINEAR;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.av_frame_alloc;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.av_image_fill_arrays;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.av_image_get_buffer_size;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.av_malloc;
...
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.avcodec_alloc_context3;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.avcodec_find_decoder;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.avcodec_open2;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.avcodec_parameters_to_context;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.avcodec_receive_frame;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.avcodec_send_packet;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.sws_getContext;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg.sws_scale;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg$shared.C_CHAR;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg$shared.C_INT;
import static io.github.chrisribble.ffm.ffmpeg.bindings.FFmpeg$shared.C_POINTER;
import static io.github.chrisribble.ffm.ffmpeg.core.internal.Macros.AVERROR;
...
import io.github.chrisribble.ffm.ffmpeg.bindings.AVCodec;
import io.github.chrisribble.ffm.ffmpeg.bindings.AVCodecContext;
import io.github.chrisribble.ffm.ffmpeg.bindings.AVFrame;
...
import io.github.chrisribble.ffm.ffmpeg.core.exception.AVException;
...
import io.github.chrisribble.ffm.ffmpeg.core.internal.RuntimeErrno;
import io.github.chrisribble.ffm.ffmpeg.core.internal.StreamInfo;

public final class BufferedImageSpliterator implements Spliterator<BufferedImage>, AutoCloseable {
	...
	private BufferedImageSpliterator(final Builder builder) {
		arena = builder.arena;
	...
	private void init() {
		...
		srcResolution = decoderContext.resolution();
	...
	public static final class Builder {
		...
		public BufferedImageSpliterator build() throws FileNotFoundException {
			...
			return new BufferedImageSpliterator(this);
		}
	}
}
