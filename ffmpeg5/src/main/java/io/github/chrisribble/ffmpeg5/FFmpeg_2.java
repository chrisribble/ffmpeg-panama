...
public class FFmpeg_2 extends FFmpeg_3 {
    ...
    private static class av_mallocz_array {
        public static final FunctionDescriptor DESC = FunctionDescriptor.of(
            FFmpeg.C_POINTER,
            FFmpeg.C_LONG,
            FFmpeg.C_LONG
        ...
        public static final MethodHandle HANDLE = Linker.nativeLinker().downcallHandle(
                    FFmpeg.findOrThrow("av_mallocz_array"),
                    DESC);
    }
     ...
     * }
     */
    public static FunctionDescriptor av_mallocz_array$descriptor() {
        return av_mallocz_array.DESC;
    }
     ...
     * }
     */
    public static MethodHandle av_mallocz_array$handle() {
        return av_mallocz_array.HANDLE;
    }
    /**
     * {@snippet lang=c :
     * void *av_mallocz_array(size_t nmemb, size_t size)
    ...
    public static MemorySegment av_mallocz_array(long nmemb, long size) {
        var mh$ = av_mallocz_array.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("av_mallocz_array", nmemb, size);
            }
            return (MemorySegment)mh$.invokeExact(nmemb, size);
        } catch (Throwable ex$) {
           throw new AssertionError("should not reach here", ex$);
    ...
    private static final int AV_PIX_FMT_NB = (int)206L;
    /**
     * {@snippet lang=c :
    ...
    private static class av_get_colorspace_name {
        public static final FunctionDescriptor DESC = FunctionDescriptor.of(
            FFmpeg.C_POINTER,
            FFmpeg.C_INT
        );
        ...
        public static final MethodHandle HANDLE = Linker.nativeLinker().downcallHandle(
                    FFmpeg.findOrThrow("av_get_colorspace_name"),
                    DESC);
    }
     ...
     * }
     */
    public static FunctionDescriptor av_get_colorspace_name$descriptor() {
        return av_get_colorspace_name.DESC;
    }
     ...
     * }
     */
    public static MethodHandle av_get_colorspace_name$handle() {
        return av_get_colorspace_name.HANDLE;
    }
    /**
     * {@snippet lang=c :
     * const char *av_get_colorspace_name(enum AVColorSpace val)
    ...
    public static MemorySegment av_get_colorspace_name(int val) {
        var mh$ = av_get_colorspace_name.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("av_get_colorspace_name", val);
            }
