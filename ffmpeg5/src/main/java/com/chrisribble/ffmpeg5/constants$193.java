...
final class constants$193 {
    ...
    static final VarHandle const$1 = constants$193.const$0.varHandle(MemoryLayout.PathElement.groupElement("codec_type"));
    static final VarHandle const$2 = constants$193.const$0.varHandle(MemoryLayout.PathElement.groupElement("codec_id"));
    static final VarHandle const$3 = constants$193.const$0.varHandle(MemoryLayout.PathElement.groupElement("codec_tag"));
    static final VarHandle const$4 = constants$193.const$0.varHandle(MemoryLayout.PathElement.groupElement("extradata"));
    static final VarHandle const$5 = constants$193.const$0.varHandle(MemoryLayout.PathElement.groupElement("extradata_size"));
}
