...
public class tm {
    ...
    public static int tm_mday$get(MemorySegment seg) {
        return (int)constants$260.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int tm_mday$get(MemorySegment seg, long index) {
        return (int)constants$260.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int tm_mon$get(MemorySegment seg) {
        return (int)constants$261.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int tm_mon$get(MemorySegment seg, long index) {
        return (int)constants$261.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int tm_year$get(MemorySegment seg) {
        return (int)constants$261.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int tm_year$get(MemorySegment seg, long index) {
        return (int)constants$261.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int tm_wday$get(MemorySegment seg) {
        return (int)constants$261.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int tm_wday$get(MemorySegment seg, long index) {
        return (int)constants$261.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int tm_yday$get(MemorySegment seg) {
        return (int)constants$261.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int tm_yday$get(MemorySegment seg, long index) {
        return (int)constants$261.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int tm_isdst$get(MemorySegment seg) {
        return (int)constants$261.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int tm_isdst$get(MemorySegment seg, long index) {
        return (int)constants$261.const$4.get(seg.asSlice(index*sizeof()));
    }
