...
final class constants$306 {
    ...
    static final VarHandle const$1 = constants$306.const$0.varHandle(MemoryLayout.PathElement.groupElement("index"));
    static final VarHandle const$2 = constants$306.const$0.varHandle(MemoryLayout.PathElement.groupElement("id"));
    static final VarHandle const$3 = constants$306.const$0.varHandle(MemoryLayout.PathElement.groupElement("priv_data"));
    static final VarHandle const$4 = constants$306.const$0.varHandle(MemoryLayout.PathElement.groupElement("start_time"));
    static final VarHandle const$5 = constants$306.const$0.varHandle(MemoryLayout.PathElement.groupElement("duration"));
}
