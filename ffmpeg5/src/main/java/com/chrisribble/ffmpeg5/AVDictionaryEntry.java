...
public class AVDictionaryEntry {
    ...
    public static MemorySegment value$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$153.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment value$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$153.const$5.get(seg.asSlice(index*sizeof()));
    }
