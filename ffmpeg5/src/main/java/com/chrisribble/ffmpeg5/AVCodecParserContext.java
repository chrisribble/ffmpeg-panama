 ...
 *     long cur_frame_offset[4];
 *     long cur_frame_pts[4];
 *     long cur_frame_dts[4];
 *     int flags;
 *     long offset;
 *     long cur_frame_end[4];
 *     int key_frame;
 *     int dts_sync_point;
 *     int dts_ref_dts_delta;
 *     int pts_dts_delta;
 *     long cur_frame_pos[4];
 *     long pos;
 *     long last_pos;
 *     int duration;
...
public class AVCodecParserContext {
    ...
    public static long pts$get(MemorySegment seg) {
        return (long)constants$250.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long pts$get(MemorySegment seg, long index) {
        return (long)constants$250.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long last_pts$get(MemorySegment seg) {
        return (long)constants$250.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long last_pts$get(MemorySegment seg, long index) {
        return (long)constants$250.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long last_dts$get(MemorySegment seg) {
        return (long)constants$250.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long last_dts$get(MemorySegment seg, long index) {
        return (long)constants$250.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long last_pos$get(MemorySegment seg) {
        return (long)constants$252.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long last_pos$get(MemorySegment seg, long index) {
        return (long)constants$252.const$3.get(seg.asSlice(index*sizeof()));
    }
