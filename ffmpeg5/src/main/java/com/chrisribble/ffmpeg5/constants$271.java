...
final class constants$271 {
    ...
    static final VarHandle const$0 = constants$270.const$5.varHandle(MemoryLayout.PathElement.groupElement("url_context"));
    ...
    static final VarHandle const$2 = constants$271.const$1.varHandle(MemoryLayout.PathElement.groupElement("av_class"));
    static final VarHandle const$3 = constants$271.const$1.varHandle(MemoryLayout.PathElement.groupElement("buffer"));
    static final VarHandle const$4 = constants$271.const$1.varHandle(MemoryLayout.PathElement.groupElement("buffer_size"));
    static final VarHandle const$5 = constants$271.const$1.varHandle(MemoryLayout.PathElement.groupElement("buf_ptr"));
}
