...
public class AVProgram {
    ...
    public static long start_time$get(MemorySegment seg) {
        return (long)constants$312.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long start_time$get(MemorySegment seg, long index) {
        return (long)constants$312.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long end_time$get(MemorySegment seg) {
        return (long)constants$313.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long end_time$get(MemorySegment seg, long index) {
        return (long)constants$313.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long pts_wrap_reference$get(MemorySegment seg) {
        return (long)constants$313.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long pts_wrap_reference$get(MemorySegment seg, long index) {
        return (long)constants$313.const$1.get(seg.asSlice(index*sizeof()));
    }
