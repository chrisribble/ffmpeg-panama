 ...
 * char* (*item_name)(void*);
    ...
    public interface item_name {
        ...
        static MemorySegment allocate(item_name fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$143.const$4, fi, constants$69.const$2, scope);
        }
        static item_name ofAddress(MemorySegment addr, Arena arena) {
            MemorySegment symbol = addr.reinterpret(arena, null);
            return (java.lang.foreign.MemorySegment __x0) -> {
                try {
                    return (java.lang.foreign.MemorySegment)constants$143.const$5.invokeExact(symbol, __x0);
                } catch (Throwable ex$) {
    ...
    public static MemorySegment option$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$144.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment option$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$144.const$1.get(seg.asSlice(index*sizeof()));
    }
 ...
 * AVClassCategory (*get_category)(void*);
    ...
    public interface get_category {
        ...
        static MemorySegment allocate(get_category fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$145.const$0, fi, constants$0.const$3, scope);
        }
 ...
 * int (*query_ranges)(struct AVOptionRanges**,void*,char*,int);
    ...
    public interface query_ranges {
        ...
        static MemorySegment allocate(query_ranges fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$145.const$3, fi, constants$145.const$2, scope);
        }
        static query_ranges ofAddress(MemorySegment addr, Arena arena) {
            ...
            return (java.lang.foreign.MemorySegment __x0, java.lang.foreign.MemorySegment __x1, java.lang.foreign.MemorySegment __x2, int __x3) -> {
                try {
                    return (int)constants$145.const$4.invokeExact(symbol, __x0, __x1, __x2, __x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemorySegment query_ranges$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$145.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment query_ranges$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$145.const$5.get(seg.asSlice(index*sizeof()));
    }
 ...
 * void* (*child_next)(void*,void*);
    ...
    public interface child_next {
        ...
        static MemorySegment allocate(child_next fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$146.const$0, fi, constants$69.const$5, scope);
        }
        static child_next ofAddress(MemorySegment addr, Arena arena) {
            MemorySegment symbol = addr.reinterpret(arena, null);
            return (java.lang.foreign.MemorySegment __x0, java.lang.foreign.MemorySegment __x1) -> {
                try {
                    return (java.lang.foreign.MemorySegment)constants$146.const$1.invokeExact(symbol, __x0, __x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
 ...
 * struct AVClass* (*child_class_iterate)(void**);
    ...
    public interface child_class_iterate {
        ...
        static MemorySegment allocate(child_class_iterate fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$146.const$3, fi, constants$69.const$2, scope);
        }
