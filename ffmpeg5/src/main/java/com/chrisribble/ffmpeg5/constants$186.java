...
final class constants$186 {
    ...
    static final VarHandle const$0 = constants$185.const$5.varHandle(MemoryLayout.PathElement.groupElement("profile"));
    static final VarHandle const$1 = constants$185.const$5.varHandle(MemoryLayout.PathElement.groupElement("name"));
    ...
    static final VarHandle const$3 = constants$186.const$2.varHandle(MemoryLayout.PathElement.groupElement("name"));
    static final VarHandle const$4 = constants$186.const$2.varHandle(MemoryLayout.PathElement.groupElement("long_name"));
    static final VarHandle const$5 = constants$186.const$2.varHandle(MemoryLayout.PathElement.groupElement("type"));
}
