...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        FFmpeg.C_INT.withName("__lock"),
        FFmpeg.C_INT.withName("__count"),
        FFmpeg.C_INT.withName("__owner"),
        FFmpeg.C_INT.withName("__nusers"),
        FFmpeg.C_INT.withName("__kind"),
        FFmpeg.C_SHORT.withName("__spins"),
        FFmpeg.C_SHORT.withName("__elision"),
