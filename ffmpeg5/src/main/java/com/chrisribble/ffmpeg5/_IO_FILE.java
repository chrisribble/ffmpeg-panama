...
public class _IO_FILE {
    ...
    public static short _cur_column$get(MemorySegment seg) {
        return (short)constants$63.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short _cur_column$get(MemorySegment seg, long index) {
        return (short)constants$63.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long _offset$get(MemorySegment seg) {
        return (long)constants$64.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long _offset$get(MemorySegment seg, long index) {
        return (long)constants$64.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long __pad5$get(MemorySegment seg) {
        return (long)constants$65.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long __pad5$get(MemorySegment seg, long index) {
        return (long)constants$65.const$0.get(seg.asSlice(index*sizeof()));
    }
