...
final class constants$269 {
    ...
    static final VarHandle const$4 = constants$269.const$2.varHandle(MemoryLayout.PathElement.groupElement("callback"));
    static final VarHandle const$5 = constants$269.const$2.varHandle(MemoryLayout.PathElement.groupElement("opaque"));
}
