 ...
 *     int (*parser_parse)(struct AVCodecParserContext*,struct AVCodecContext*,unsigned char**,int*,unsigned char*,int);
 *     void (*parser_close)(struct AVCodecParserContext*);
 *     int (*split)(struct AVCodecContext*,unsigned char*,int);
 * };
 * }
 */
 ...
 * int (*parser_init)(struct AVCodecParserContext*);
    ...
    public interface parser_init {
        ...
        static MemorySegment allocate(parser_init fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$254.const$3, fi, constants$0.const$3, scope);
        }
 ...
 * int (*parser_parse)(struct AVCodecParserContext*,struct AVCodecContext*,unsigned char**,int*,unsigned char*,int);
    ...
    public interface parser_parse {
        ...
        static MemorySegment allocate(parser_parse fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$255.const$0, fi, constants$254.const$5, scope);
        }
        static parser_parse ofAddress(MemorySegment addr, Arena arena) {
            ...
            return (java.lang.foreign.MemorySegment __x0, java.lang.foreign.MemorySegment __x1, java.lang.foreign.MemorySegment __x2, java.lang.foreign.MemorySegment __x3, java.lang.foreign.MemorySegment __x4, int __x5) -> {
                try {
                    return (int)constants$255.const$1.invokeExact(symbol, __x0, __x1, __x2, __x3, __x4, __x5);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemorySegment parser_parse$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$255.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment parser_parse$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$255.const$2.get(seg.asSlice(index*sizeof()));
    }
 ...
 * void (*parser_close)(struct AVCodecParserContext*);
    ...
    public interface parser_close {
        ...
        static MemorySegment allocate(parser_close fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$255.const$3, fi, constants$70.const$2, scope);
        }
    ...
    public static MemorySegment parser_close$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$255.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment parser_close$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$255.const$4.get(seg.asSlice(index*sizeof()));
    }
 ...
 * int (*split)(struct AVCodecContext*,unsigned char*,int);
    ...
    public interface split {
        ...
        static MemorySegment allocate(split fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$255.const$5, fi, constants$110.const$5, scope);
        }
    ...
    public static MemorySegment split$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$256.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment split$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$256.const$0.get(seg.asSlice(index*sizeof()));
    }
