...
final class constants$312 {
    ...
    static final VarHandle const$0 = constants$311.const$2.varHandle(MemoryLayout.PathElement.groupElement("metadata"));
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(av_format_control_message.class, "apply", constants$205.const$5);
    ...
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(AVOpenCallback.class, "apply", constants$312.const$2);
    static final MethodHandle const$4 = RuntimeHelper.downcallHandle(
        constants$312.const$2
    );
